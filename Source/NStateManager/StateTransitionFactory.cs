...
namespace NStateManager
{
        ...
        where TState : IComparable
    {
        ...
        public static StateTransitionBase<T, TState, TTrigger> GetStateTransition(Async.IStateMachine<T, TState, TTrigger> stateMachine, Func<T, CancellationToken, Task<TState>> stateFunctionAsync, string name, uint priority = 1)
        {
            return new Async.StateTransitionDynamic<T, TState, TTrigger>(stateMachine.StateAccessor, stateMachine.StateMutator, stateFunctionAsync, name, priority);
        }
